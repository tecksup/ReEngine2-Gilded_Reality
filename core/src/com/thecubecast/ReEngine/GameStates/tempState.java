...
public class tempState extends GameState {
    ...
    public tempState(GameStateManager gsm) {
        super(gsm);
    }
    ...
    public void init() {
            ...
            for(int objectCount = 0; objectCount < tiledMap.getLayers().get("Objects").getObjects().getCount(); objectCount++) {
                if (tiledMap.getLayers().get("Objects").getObjects().get(objectCount) instanceof RectangleMapObject) {
                    ...
                    if (tempObj.getName().equals("Desk")) {
                        WorldObject Desk = new WorldObject((int) tempObj.getRectangle().x, (int) tempObj.getRectangle().y, new Vector3(16, 16, 0)) {
                        ...
                        WorldObject Desk = new WorldObject((int) tempObj.getRectangle().x, (int) tempObj.getRectangle().y, new Vector3(tempObj.getRectangle().width, tempObj.getRectangle().height, 0)) {
                            ...
                            public void draw(RePipeline batch, float Time) {
                                ...
                                batch.draw(tiledBits.getBitTiles().get(10)[1],getPosition().x ,getPosition().y+32);
                                batch.draw(tiledBits.getBitTiles().get(10)[5],getPosition().x ,getPosition().y+48);
                                batch.draw(tiledBits.getBitTiles().get(10)[5],getPosition().x ,getPosition().y+64);
                                batch.draw(tiledBits.getBitTiles().get(10)[5],getPosition().x ,getPosition().y+80);
                                batch.draw(tiledBits.getBitTiles().get(10)[5],getPosition().x ,getPosition().y+96);
                                batch.draw(tiledBits.getBitTiles().get(10)[5],getPosition().x ,getPosition().y+112);
                                batch.draw(tiledBits.getBitTiles().get(10)[4],getPosition().x ,getPosition().y+128);
                            }
                        };
                    ...
                    } else if (tempObj.getName().equals("Gaurd")) {
        ...
        Hank hank = new Hank(21*16, 15*16) {
            ...
            public void interact() {
                ...
                AddDialog(temp);
                AddDialog(getName(), "Soon I will be aloud to walk around!");
            }
        };
        hank.init(gsm.Width, gsm.Height);
        hank.setVelocity(0, -1);

        WorldObject H_closet = new HiddenArea(13*16+2, 12*16, new Vector3(6*16-10, 7*16-8, 0), WorldObject.type.Static, true) {
            ...
            public void draw(SpriteBatch batch, float Time) {
                ...
                batch.draw(tiledBits.getBitTiles().get(7)[7].getDiffuse() ,getPosition().x -2,getPosition().y);
                batch.draw(tiledBits.getBitTiles().get(7)[15].getDiffuse(),getPosition().x -2 +16 ,getPosition().y);
                batch.draw(tiledBits.getBitTiles().get(7)[15].getDiffuse(),getPosition().x -2 +32 ,getPosition().y);
                batch.draw(tiledBits.getBitTiles().get(7)[15].getDiffuse(),getPosition().x -2 +48 ,getPosition().y);
                batch.draw(tiledBits.getBitTiles().get(7)[15].getDiffuse(),getPosition().x -2 +64 ,getPosition().y);
                batch.draw(tiledBits.getBitTiles().get(7)[13].getDiffuse(),getPosition().x -2 +80 ,getPosition().y);

                batch.draw(tiledBits.getBitTiles().get(7)[7].getDiffuse(),getPosition().x -2  ,getPosition().y+16);
                batch.draw(tiledBits.getBitTiles().get(7)[15].getDiffuse(),getPosition().x -2 +16 ,getPosition().y+16);
                batch.draw(tiledBits.getBitTiles().get(7)[15].getDiffuse(),getPosition().x -2 +32 ,getPosition().y+16);
                batch.draw(tiledBits.getBitTiles().get(7)[15].getDiffuse(),getPosition().x -2 +48 ,getPosition().y+16);
                batch.draw(tiledBits.getBitTiles().get(7)[15].getDiffuse(),getPosition().x -2 +64 ,getPosition().y+16);
                batch.draw(tiledBits.getBitTiles().get(7)[13].getDiffuse(),getPosition().x -2 +80 ,getPosition().y+16);

                batch.draw(tiledBits.getBitTiles().get(7)[7].getDiffuse(),getPosition().x -2  ,getPosition().y+32);
                batch.draw(tiledBits.getBitTiles().get(7)[15].getDiffuse(),getPosition().x -2 +16 ,getPosition().y+32);
                batch.draw(tiledBits.getBitTiles().get(7)[15].getDiffuse(),getPosition().x -2 +32 ,getPosition().y+32);
                batch.draw(tiledBits.getBitTiles().get(7)[15].getDiffuse(),getPosition().x -2 +48 ,getPosition().y+32);
                batch.draw(tiledBits.getBitTiles().get(7)[15].getDiffuse(),getPosition().x -2 +64 ,getPosition().y+32);
                batch.draw(tiledBits.getBitTiles().get(7)[13].getDiffuse(),getPosition().x -2 +80 ,getPosition().y+32);

                batch.draw(tiledBits.getBitTiles().get(7)[7].getDiffuse(),getPosition().x -2  ,getPosition().y+48);
                batch.draw(tiledBits.getBitTiles().get(7)[15].getDiffuse(),getPosition().x -2 +16 ,getPosition().y+48);
                batch.draw(tiledBits.getBitTiles().get(7)[15].getDiffuse(),getPosition().x -2 +32 ,getPosition().y+48);
                batch.draw(tiledBits.getBitTiles().get(7)[15].getDiffuse(),getPosition().x -2 +48 ,getPosition().y+48);
                batch.draw(tiledBits.getBitTiles().get(7)[15].getDiffuse(),getPosition().x -2 +64 ,getPosition().y+48);
                batch.draw(tiledBits.getBitTiles().get(7)[13].getDiffuse(),getPosition().x -2 +80 ,getPosition().y+48);

                batch.draw(tiledBits.getBitTiles().get(7)[7].getDiffuse(),getPosition().x -2  ,getPosition().y+64);
                batch.draw(tiledBits.getBitTiles().get(7)[15].getDiffuse(),getPosition().x -2 +16 ,getPosition().y+64);
                batch.draw(tiledBits.getBitTiles().get(7)[15].getDiffuse(),getPosition().x -2 +32 ,getPosition().y+64);
                batch.draw(tiledBits.getBitTiles().get(7)[15].getDiffuse(),getPosition().x -2 +48 ,getPosition().y+64);
                batch.draw(tiledBits.getBitTiles().get(7)[15].getDiffuse(),getPosition().x -2 +64 ,getPosition().y+64);
                batch.draw(tiledBits.getBitTiles().get(7)[13].getDiffuse(),getPosition().x -2 +80 ,getPosition().y+64);

                batch.draw(tiledBits.getBitTiles().get(7)[7].getDiffuse(),getPosition().x -2  ,getPosition().y+80);
                batch.draw(tiledBits.getBitTiles().get(7)[15].getDiffuse(),getPosition().x -2 +16 ,getPosition().y+80);
                batch.draw(tiledBits.getBitTiles().get(7)[15].getDiffuse(),getPosition().x -2 +32 ,getPosition().y+80);
                batch.draw(tiledBits.getBitTiles().get(7)[15].getDiffuse(),getPosition().x -2 +48 ,getPosition().y+80);
                batch.draw(tiledBits.getBitTiles().get(7)[15].getDiffuse(),getPosition().x -2 +64 ,getPosition().y+80);
                batch.draw(tiledBits.getBitTiles().get(7)[13].getDiffuse(),getPosition().x -2 +80 ,getPosition().y+80);

                batch.draw(tiledBits.getBitTiles().get(7)[6].getDiffuse(),getPosition().x -2  ,getPosition().y+96);
                batch.draw(tiledBits.getBitTiles().get(7)[14].getDiffuse(),getPosition().x -2 +16 ,getPosition().y+96);
                batch.draw(tiledBits.getBitTiles().get(7)[14].getDiffuse(),getPosition().x -2 +32 ,getPosition().y+96);
                batch.draw(tiledBits.getBitTiles().get(7)[14].getDiffuse(),getPosition().x -2 +48 ,getPosition().y+96);
                batch.draw(tiledBits.getBitTiles().get(7)[14].getDiffuse(),getPosition().x -2 +64 ,getPosition().y+96);
                batch.draw(tiledBits.getBitTiles().get(7)[14].getDiffuse(),getPosition().x -2 +80 ,getPosition().y+96);
                batch.setColor(temp);
            }
    ...
    public void draw(SpriteBatch g, int height, int width, float Time) {
        ...
        RePipeTextureRegionDrawable layer1 = new RePipeTextureRegionDrawable() {
            @Override
            public void DrawDiffuse(SpriteBatch batch) {
                tiledBits.drawLayer(batch, 16, Time,0, player.getPosition().y, camView);
        ...
        tiledBits.drawLayer(Repipe, 16, Time,0, player.getPosition().y, camView);
        tiledBits.drawLayer(Repipe, 16, Time,1, player.getPosition().y, camView);
        tiledBits.drawLayer(Repipe, 16, Time,2, player.getPosition().y, camView);
